...
def brand_palette(theme_id: str) -> dict[str, str]:
    ...
    return {
        ...
        "link": "#FFAD70" if dark else ACCESSIBLE_ORANGE,
        "subtleText": "#85858F" if dark else "#656574",
        "headingText": "#ECECEF" if dark else "#18181B",
        "inlineCodeSurface": "#26262B" if dark else "#ECECF1",
        "quoteSurface": "#232327" if dark else "#F4F4F7",
        ...
        "focus": BRAND_ORANGE if dark else ACCESSIBLE_ORANGE,
