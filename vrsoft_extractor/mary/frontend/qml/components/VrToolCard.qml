            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.preferredWidth: copyTextLabel.implicitWidth + 12
                        radius: 3
                        color: copyHover.hovered ? Theme.palette.hover : "transparent"
                        border.width: 1
                        border.color: Theme.palette.chatBorder
                        ...
                        Text {
                            id: copyTextLabel
                            anchors.centerIn: parent
                            text: root.copiedOutput ? "Copiado!" : "Copiar detalhes"
                            color: Theme.palette.mutedText
                            font.family: Theme.fontFamily
                            font.pixelSize: Theme.fontSizeMicro
                            renderType: Theme.textRenderType
                        ...
                        TapHandler {
                            onTapped: {
                                if (typeof studio !== "undefined" && studio) {
                                    studio.copyText(root.detailText)
                                }
                ...
                // Output / Detail text area
                Rectangle {
                    visible: root.detailText.length > 0
                    Layout.fillWidth: true
                    Layout.preferredHeight: Math.min(detailArea.implicitHeight + 16, 220)
                    radius: 4
